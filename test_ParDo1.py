...
with beam.Pipeline('DirectRunner', options=opts) as p:
    ...
    query_results = p | beam.io.Read(beam.io.BigQuerySource(query='SELECT person, race_ethnicity, race_ethnicity_confidence, year_of_award, award FROM Oscar_Academy_Awards_Demographics.Demographics'))
